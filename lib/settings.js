...
exports.shared_pages = {
  ...
  "page_title": "eIquidus",
  // meta tags:
  // basic SEO data: description, author, keywords
  // more meta tags related to X, fb etc can be added here
  // any meta tag is to be implemented in settings.json, lib/settings.js and in views/layout.pug
  // 3 places to care about - just repeat the pattern
  // basic seo
  "head_description": "Dingocoin Block Explorer. Information on all Dingocoin transactions and blocks.",
  "head_author": "Various authors listed in file LICENSE (located on code root). Dingocoin specific settings added by Dingocoin Project.",
  "head_keywords": "Block, Explorer, Of, Dingocoin, Such, a, Wild, Doge",
  // og protocol
  "head_og_title_property": "og:title",
  "head_og_title_content": "Dingocoin - A Wild Crypto Movement Spreading Happiness.",
  "head_og_descr_property": "og:description",
  "head_og_descr_content": "Dingocoin is the most successful cryptocurrency fork of Dogecoin, with revolutionary innovations and unstoppable developments. It is a community driven cryptocurrency that is inspired by the Australian dingo.",
  "head_og_image_property": "og:image",
  "head_og_image_content": "https://explorer.dingocoin.com/dingocoin_og.png",
  "head_og_url_property": "og:url",
  "head_og_url_content": "https://dingocoin.com/",
  "head_og_type_property": "og:type",
  "head_og_type_content": "website",
  // x
  "head_x_card_name": "twitter:card",
  "head_x_card_content": "summary_large_image",
  "head_x_title_name": "twitter:title",
  "head_x_title_content": "Dingocoin - A Wild Crypto Movement Spreading Happiness.",
  "head_x_descr_name": "twitter:description",
  "head_x_descr_content": "Dingocoin is the most successful cryptocurrency fork of Dogecoin, with revolutionary innovations and unstoppable developments. It is a community driven cryptocurrency that is inspired by the Australian dingo.",
  "head_x_image_name": "twitter:image",
  "head_x_image_content": "https://explorer.dingocoin.com/dingocoin_x.png",
  "head_x_url_name": "twitter:url",
  "head_x_url_content": "https://dingocoin.com/",
  ...
  "page_header": {
    ...
    // home_link URL, Dingocoin specific. Remove target="_blank" in views/layout.pug if needed
    // also changed in a template lib/settings.json
    "home_link_url": "https://dingocoin.com/",
